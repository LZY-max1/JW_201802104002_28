...
let SchoolService = class SchoolService {
    ...
    updateCollege(college) {
        return this.http.put(this.collegeUrl + 'update.ctl', college, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateCollege')));
    }
    /**
...
module.exports = __webpack_require__(/*! D:\Angular2Test\myschool2\src\main.ts */"./src/main.ts");
